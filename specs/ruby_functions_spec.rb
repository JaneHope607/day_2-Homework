...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    volume_cube_result = volume_of_cube(6)
    assert_equal(216, volume_cube_result)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_sphere_result = volume_of_sphere(3.0)
    assert_equal(113, volume_sphere_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    f_to_c_result = fahrenheit_to_celsius(56)
    assert_equal(13, f_to_c_result)
  end
